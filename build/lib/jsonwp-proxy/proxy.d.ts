...
export class JWProxy {
     ...
     */
    requestToCommandName(url: string, method: import('armor-types').HTTPMethod): string | undefined;
    /**
     *
     * @param {string} url
     * @param {import('armor-types').HTTPMethod} method
     * @param {any?} body
     */
    proxyCommand(url: string, method: import('armor-types').HTTPMethod, body?: any | null): Promise<any>;
    /**
     *
     * @param {string} url
     * @param {import('armor-types').HTTPMethod} method
     ...
     */
    command(url: string, method: import('armor-types').HTTPMethod, body?: any | null): Promise<unknown>;
