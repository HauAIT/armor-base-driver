...
class DeviceSettings {
    ...
    async update(newSettings) {
        ...
        if (armor_support_1.node.getObjectSize({ ...this._settings, ...newSettings }) >= exports.MAX_SETTINGS_SIZE) {
            throw new errors_1.errors.InvalidArgumentError(`New settings cannot be applied, because the overall ` +
                `object size exceeds the allowed limit of ${armor_support_1.util.toReadableSizeString(exports.MAX_SETTINGS_SIZE)}`);
        }
 ...
 * @typedef {import('armor-types').IDeviceSettings<T>} IDeviceSettings
 */
