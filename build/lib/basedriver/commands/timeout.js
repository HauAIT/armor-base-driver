...
const TimeoutCommands = {
    async timeouts(type, ms, script, pageLoad, implicit) {
        if (armor_support_1.util.hasValue(type) && armor_support_1.util.hasValue(ms)) {
        ...
        if (armor_support_1.util.hasValue(script)) {
            await this.scriptTimeoutW3C(script);
        }
        if (armor_support_1.util.hasValue(pageLoad)) {
            await this.pageLoadTimeoutW3C(pageLoad);
        }
        if (armor_support_1.util.hasValue(implicit)) {
