...
const armor_types_1 = require("armor-types");
...
class BaseDriver extends core_1.DriverCore {
    ...
    get _desiredCapConstraints() {
        return Object.freeze(lodash_1.default.merge({}, armor_types_1.BASE_DESIRED_CAP_CONSTRAINTS, this.desiredCapConstraints));
    }
    /**
    ...
    driverData) {
        ...
        if (!originalCaps) {
            throw new protocol_1.errors.SessionNotCreatedError('Armor only supports W3C-style capability objects. ' +
        ...
        this.sessionId = armor_support_1.util.uuidV4();
        this.caps = caps;
