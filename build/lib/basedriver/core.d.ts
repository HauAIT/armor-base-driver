...
/// <reference types="node" />
import type { ArmorLogger, Constraints, Core, Driver, DriverOpts, EventHistory, HTTPMethod, InitialOpts, Protocol, RouteMatcher, StringRecord } from 'armor-types';
...
export declare class DriverCore<C extends Constraints, Settings extends StringRecord = StringRecord> implements Core<C, Settings> {
     ...
     * the entrypoint for any Armor server
     */
    basePath: string;
    ...
    /**
     * This property is used by ArmorDriver to store the data of the
    ...
    /**
     * @privateRemarks Overridden in armor driver, but here so that individual drivers can be
    ...
    getManagedDrivers(): Driver<Constraints, StringRecord, StringRecord, import("armor-types").DefaultCreateSessionResult<Constraints>, void, StringRecord>[];
