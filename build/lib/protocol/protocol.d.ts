 ...
 */
export function routeConfiguringFunction(driver: import("armor-types").Core<any, import("armor-types").StringRecord>): import('../express/server').RouteConfiguringFunction;
