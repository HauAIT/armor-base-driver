...
export const METHOD_MAP: {
    ...
    readonly '/session/:sessionId/armor/device/shake': {
        readonly POST: {
            readonly command: "mobileShake";
            readonly deprecated: true;
        };
    };
    readonly '/session/:sessionId/armor/device/system_time': {
        readonly GET: {
    ...
    readonly '/session/:sessionId/armor/device/install_app': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/activate_app': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/remove_app': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/terminate_app': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/app_installed': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/hide_keyboard': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/is_keyboard_shown': {
        readonly GET: {
            readonly command: "isKeyboardShown";
        };
    };
    readonly '/session/:sessionId/armor/device/push_file': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/pull_file': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/pull_folder': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/simulator/touch_id': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/simulator/toggle_touch_id_enrollment': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/app/end_test_coverage': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/settings': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/receive_async_response': {
        readonly POST: {
            readonly command: "receiveAsyncResponse";
            readonly payloadParams: {
    ...
    readonly '/session/:sessionId/armor/events': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/log_event': {
        readonly POST: {
    ...
    readonly '/session/:sessionId/armor/device/set_clipboard': {
        readonly POST: {
 ...
 */
export function routeToCommandName(endpoint: string, method: import('armor-types').HTTPMethod, basePath?: string | undefined): string | undefined;
