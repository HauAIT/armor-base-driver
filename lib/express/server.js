...
function configureHttp({httpServer, reject, keepAliveTimeout}) {
  ...
  armorServer.addWebSocketHandler = addWebSocketHandler;
  armorServer.removeWebSocketHandler = removeWebSocketHandler;
  armorServer.removeAllWebSocketHandlers = removeAllWebSocketHandlers;
  armorServer.getWebSocketHandlers = getWebSocketHandlers;
